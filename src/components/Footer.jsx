    ...
    <div className="py-6 px-4 lg:px-8 bg-black text-white">
      <div className="w-fit mx-auto text-center">
        ...
        <div className="flex justify-center mt-8">
          <button className="px-4 py-3 bg-white rounded-sm flex items-center gap-2">
            <div className="text-sm text-black">arfilaks.dev@gmail.com</div>
            <MdContentCopy className="text-black" />
          </button>
        </div>
      </div>
